...
// /teacher/updateTaskStatus
// 批改作业
export async function checkAnswerApi (sTid, subjectId, score, file) {
    try {
        return await Ax.post(`/teacher/checkAnswer`, { sTid, subjectId, score }, {
            headers: {
...
///teacher/listStudentTimeDetail
export async function listStudentTimeDetailApi (taskId) {
    try {
        return await Ax.get('/teacher/listStudentTimeDetail', { taskId });
    } catch (e) {
    }
}
// /teacher/delTask
export async function delTaskApi (taskId) {
    try {
